...
export default function Home() {
  ...
  const tabs = [
    ...
    { id: "mail", label: t('nav.mail'), external: true, url: "https://mail.welean.top" },
    { id: "zpl", label: t('nav.zpl'), external: true, url: "https://zplprinter.welean.top" },
    { id: "creform", label: t('nav.creform'), external: false, disabled: true },
    { id: "encyclopedia", label: t('nav.encyclopedia'), external: false, disabled: true },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-white font-semibold text-lg">{t('nav.brand')}</span>
            </div>
            <div className="flex items-center space-x-4">
              ...
              <div className="relative">
                ...
                >
                  ...
                  <span>{currentLocale === 'en' ? 'EN' : t('languageSwitcher.zh')}</span>
      ...
      <main className="pt-24 pb-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-xl p-6 hover:border-gray-600 transition-colors">
              ...
              <div className="space-y-3">
                <div className="flex items-start">
                  <span className="text-gray-400 w-24 shrink-0">{t('admin.admin')}:</span>
                  <span className="text-gray-200">Kasda Polam</span>
                </div>
                <div className="flex items-start">
                  <span className="text-gray-400 w-24 shrink-0">{t('admin.email')}:</span>
                  <a href="mailto:kasdafolam985@gmail.com" className="text-blue-400 hover:text-blue-300">
                    kasdafolam985@gmail.com
                  </a>
                </div>
                <div className="flex items-start">
                  <span className="text-gray-400 w-24 shrink-0">{t('admin.server')}:</span>
                  <span className="text-gray-200">mail.welean.top</span>
                </div>
                <div className="flex items-start">
                  <span className="text-gray-400 w-24 shrink-0">{t('admin.ip')}:</span>
          ...
          <div className="bg-gradient-to-r from-blue-900/20 to-purple-900/20 border border-blue-800/30 rounded-xl p-8">
            <h2 className="text-2xl font-semibold text-white mb-6 text-center">{t('services.title')}</h2>
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
              {[
                { name: t('services.mail.name'), icon: "📧", desc: t('services.mail.description'), id: 'mail' },
                { name: t('services.zpl.name'), icon: "🏷️", desc: t('services.zpl.description'), id: 'zpl' },
                { name: t('services.creform.name'), icon: "☁️", desc: t('services.creform.description'), disabled: true, id: 'creform' },
                { name: t('services.encyclopedia.name'), icon: "🔌", desc: t('services.encyclopedia.description'), disabled: true, id: 'encyclopedia' },
              ].map((service) => (
                <div
                  key={service.id}
