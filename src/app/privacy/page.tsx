...
const updatedAt = "August 8, 2026 / 2026 年 8 月 8 日";
  ...
  return (
    <main className="min-h-screen bg-slate-50 px-5 py-10 text-slate-900 sm:px-8 sm:py-16">
      <div className="mx-auto max-w-4xl">
        <header className="mb-10 rounded-3xl bg-slate-950 px-6 py-8 text-white shadow-xl shadow-slate-900/10 sm:px-10 sm:py-10">
        ...
        <article className="space-y-8 rounded-3xl bg-white px-6 py-8 shadow-xl shadow-slate-900/5 sm:px-12 sm:py-12">
          ...
          <Section number="01" title="适用范围 / Scope">
            <p>
          ...
          <Section number="02" title="本地处理 / Local processing">
            <p>
          ...
          <Section number="03" title="收集与共享 / Collection and sharing">
            <p>
          ...
          <Section number="04" title="临时文件与保存 / Temporary files and saving">
            <p>
          ...
          <Section number="05" title="系统服务与备份 / System services and backup">
            <p>
          ...
          <Section number="06" title="儿童隐私 / Children&apos;s privacy">
            <p>
          ...
          <Section number="07" title="政策更新与联系我们 / Updates and contact">
            <p>
          ...
          <footer className="border-t border-slate-200 pt-7 text-sm text-slate-500">
            <Link className="font-medium text-blue-700 hover:text-blue-900" href="/zh">
